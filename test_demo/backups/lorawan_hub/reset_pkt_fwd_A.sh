...
iot_sk_init() {
    # setup GPIO 0-5
    echo "5" > /sys/class/gpio/export; WAIT_GPIO

    # set GPIO 0-5 as output
    echo "out" > /sys/class/gpio/gpio5/direction; WAIT_GPIO

    # write output for SX1301 reset
    echo "1" > /sys/class/gpio/gpio5/value; WAIT_GPIO
    echo "0" > /sys/class/gpio/gpio5/value; WAIT_GPIO

    # set GPIO 0-5 as input
    echo "in" > /sys/class/gpio/gpio5/direction; WAIT_GPIO
}
...
iot_sk_term() {
    ...
    then
        echo "5" > /sys/class/gpio/unexport; WAIT_GPIO
    fi
}
